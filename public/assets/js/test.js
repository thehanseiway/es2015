...
window.onload = function () {
    ...
    $('<button/>').html('Find Person').click(function () {
        var result = data.filter(overNinety);
        var byName = result.map(tranform);
